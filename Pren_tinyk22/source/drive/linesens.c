...
#define PT_L_CH_VALUE           (FTM0->CONTROLS[3].CnV)
#define PT_ML_CH_VALUE			(FTM0->CONTROLS[2].CnV)
#define PT_MR_CH_VALUE			(FTM0->CONTROLS[6].CnV)
#define PT_R_CH_VALUE			(FTM0->CONTROLS[7].CnV)
...
void lsInit(void)
{
  // todo #12.04 configure the 5 phototransistor pins as follows:
  // - pin muxing: GPIO
  ...
  // - gpio pin level: high level (= LED off)
	...
	GPIOC->PDDR |= (1<<6) | (1<<7) | (1<<15) | (1<<17) | (1<<18);

	GPIOC->PSOR |= (1<<6) | (1<<7) | (1<<15) | (1<<17) | (1<<18);
