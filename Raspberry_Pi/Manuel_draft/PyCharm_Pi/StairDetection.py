...
cv2.createTrackbar(trackbar0_name, windowName, 8, 30, nothing)  # third parameter = default value / best value 8
cv2.createTrackbar(trackbar1_name, windowName, 4, 10, nothing)  # third parameter = default value / best value 4
cv2.createTrackbar(trackbar2_name, windowName, 100, 200, nothing)  # best value 100
cv2.createTrackbar(trackbar3_name, windowName, 40, 100, nothing)  # best value: 50
cv2.createTrackbar(trackbar4_name, windowName, 313, 700, nothing)  # best value: 313
cv2.createTrackbar(trackbar5_name, windowName, 50, 200, nothing)  # best value: 50
cv2.createTrackbar(trackbar6_name, windowName, 1, 30, nothing)  # best value: 1
cv2.createTrackbar(trackbar7_name, windowName, 100, 255, nothing)  # best value: 100
cv2.createTrackbar(trackbar8_name, windowName, 120, 255, nothing)  # best value: 120
